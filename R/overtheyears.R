...
history <- tibble(name = c('Andreas', 'Denise', 'Josefine', 'Matthias', 
                           ...
                           'Anne', 'Johannes', 'Dries', 'Laura', 'Eva', 'Stefan', 'Flori', 'Dirk', 'Bernhard', 'Frederik'), 
                  ort = c('S', 'BA', 'BA', 'BA', 'BA', 'DE', 'CH', 'CH', 'CH', 'CH', 'CH', 'S', 'W', 'S', 'DE', 'S', 'S', 'S', 'S',
                                'S', 'S', 'S', 'S', 'S', 'DE', 'S', 'DE', 'S', 'DE', 'NO', 'DE', 'DE', 'DE', 'DE', 'DE', 'S', 'S', 'S', 'CH', 'W', 'BA'), 
                  earliest_meet =  c("1996-12-31", "20220604", "20220604", "20220604", 
                                     ...
                                     "2012-10-01", "2012-10-01", "20141001", "20150201", "2002-12-12", "2002-12-12", "20060217", "2011-04-01", "2006-02-10", "20220604"))
